...
class ImageSODA(SODA):
    ...
    def get_capabilities(self, params: dict) -> str:
        ...
        params["vosi-capabilities"] = self._dashboard["vosi-capabilities"]
        params["dali-examples"] = self._dashboard["dali-examples"]
        params["vosi-tables"] = self._dashboard["vosi-tables"]
        params["dal-sia"] = self._dashboard["dal-sia"]
    ...
    def handle_default(self, params: dict) -> afw_image:
        ...
        if shape[0] == "BRECT":
            ...
            return "ImageSODA: Unsupported query"
